...
{
    World world_test;
    char file[] { "/media/mh2001/SSD2/Programming/General Relativity/Geodesic_Solver/sky_box_samples/eso0932a.jpg" };
    char* ref { file };
    world_test.importSkyMap(ref);
    Camera camera_test;
    camera_test.setWidthHeight(2560, 1440);
    camera_test.setFov(70.);
    ...
    char output_image[] { "/media/mh2001/SSD2/Programming/General Relativity/Geodesic_Solver/output_images/test.jpg" };
